  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.measurementInputs}>
        <InputText value={heightFt} style={{width: screenWidth*0.2 }}  onInput={setHeightFtCallback} />
        <Text style={[styles.label, styles.measureMentLabel]}>ft </Text>
        <InputText value={heightIn} style={{width: screenWidth*0.2 }}  onInput={setHeightInCallback} />
        <Text style={[styles.label, styles.measureMentLabel]}>in </Text>
        <InputText value={weight} style={{width: screenWidth*0.2 }}  onInput={setWeightCallback} />
